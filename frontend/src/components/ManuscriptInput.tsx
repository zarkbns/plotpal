...
export const ManuscriptInput: React.FC<ManuscriptInputProps> = ({
  ...
  const isChapterProvided = formData.chapter !== '' && formData.chapter !== null;
  const isTextValid = textLength >= 20; // Check minimum length (prompt notes min 200 chars for full manuscript scenes, enabled once text + time provided)
